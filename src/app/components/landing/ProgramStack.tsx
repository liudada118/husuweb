...
import styles from "./program-stack.module.css";
import { imageSrc } from "./shared";

type ProgramStackItem = {
  description: string;
  href?: string;
  image: string;
  tag: string;
...
export function ProgramStack({ desktopWidth, items }: ProgramStackProps) {
