...
const zoeAchievements = [
  ...
  "Represented an offshore USD fund of a well-known fund in initiating an equity and creditor’s rights investment agreement (redemption and bond) dispute against a domestic high-tech enterprise and its founder before the Hong Kong International Arbitration Centre (HKIAC). The arbitration was conducted under the HKIAC Administered Arbitration Rules, involving over USD 20 million, with Hong Kong law as the governing law and English as the arbitration language. Assisted the client in successfully preserving the counterparty’s property in mainland China. Ultimately forced the counterparty to proactively settle with the client before the hearing and pay most of the claimed amount, achieving a satisfactory result for the client.",
  ...
  "Represented an offshore USD fund of a well-known fund in initiating a loan contract dispute against a medical device company and its founder before the Hong Kong International Arbitration Centre (HKIAC). The arbitration was conducted under the HKIAC Administered Arbitration Rules, involving over USD 9 million, with Hong Kong law as the governing law and English as the arbitration language. Assisted the client in successfully preserving the counterparty’s property in mainland China. Ultimately obtained a favorable award, with the arbitral tribunal upholding most of the client’s claims.",
  ...
  "Represented a well-known US fund in filing an arbitration case before the Beijing Arbitration Commission(BAC) against a well-known real estate company regarding a redemption right dispute. The disputed amount exceeded USD 190 million; successfully assisted the client in preserving the other party’s assets and ultimately obtained a favorable award.",
  ...
  "Represented a real estate development company in an application to the Beijing Fourth Intermediate People’s Court to successfully set aside an arbitral award rendered by a famous arbitration commission in a dispute over an equity transfer agreement with an investment company, involving a dispute amount of over RMB 53 million.",
  ...
  "Represented ED & F Man, a UK company, in an application to the Beijing First Intermediate People’s Court for recognition and enforcement of an arbitral award rendered by the London Sugar Association involving over USD 20 million. Ultimately, assisted the client in enforcing most of the award amount (over 10 years had passed since the award was rendered).",
];
...
const zhTeamDetails: Record<string, TeamProfile["zh"]> = {
  ...
  "zoe-zhang": {
    serviceIndustries: ["涉外及跨境争议解决（诉讼及仲裁）", "国际仲裁", "私募股权投资", "国际贸易", "建筑工程", "股权转让", "知识产权", "金融", "生物医药等"],
    ...
    achievements: [
      ...
      "代表某知名基金境外美元基金在香港国际仲裁中心（HKIAC）提起针对某医疗器械企业及其创始人的贷款合同争议案件，仲裁程序适用《香港国际仲裁中心机构仲裁规则》，争议标的逾900万美元，适用法律为香港法，仲裁语言为英文；在案件中协助客户成功在中国大陆保全对方财产。最终获得胜诉裁决，仲裁庭支持了客户绝大部分仲裁请求。",
      ...
      "代表某知名美元基金在北京仲裁委员会提起针对国内某知名地产公司的回购权纠纷仲裁案，争议标的超过1.9亿美元；同时成功协助客户保全对方财产，获得胜诉裁决。",
      ...
      "代表某房地产开发公司处理其与某投资公司股权转让协议纠纷一案，向北京市第四中级人民法院提起申请，成功撤销某知名仲裁委员会作出的仲裁裁决，争议标的逾人民币5300多万元。",
      ...
      "代表英国公司ED & F Man在北京市第一中级人民法院申请承认及执行一份英国伦敦糖业协会作出的仲裁裁决，裁决金额逾2,000万美元，最终帮助客户执行到位绝大部分裁决金额（彼时距裁决做出已逾10年）。",
    ],
  },
  "mengcheng-yun": {
...
export const teamProfiles: TeamProfile[] = [
  ...
  },
  {
    ...
    serviceIndustries: ["Foreign-related and Cross-border Dispute Resolution (Litigation and Arbitration)", "International Arbitration", "Private Equity Investment", "International Trade", "Construction", "Equity Transfer", "Intellectual Properties", "Finance", "Biological Medicine etc"],
    education:
      "Bachelor of Laws & Bachelor of English (Double Degree), Beijing Foreign Studies University , 2007; Master of Laws, Beijing Foreign Studies University , 2010 ; 2018 UK Bar Council Training Scheme; 2025 HKIAC Advanced Arbitrator Training Programme",
    qualification: "Bar Admission in the People's Republic of China",
    languages: ["Mandarin", "English"],
    socialEngagements:
