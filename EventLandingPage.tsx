...
import eventDate1 from "../../../assets/eventDate1.png";
import eventDate2 from "../../../assets/eventDate2.png";
import eventDate3 from "../../../assets/eventDate3.png";
import eventDate4 from "../../../assets/eventDate4.jpg";
import eventDate5 from "../../../assets/eventdate/eventDate5.jpeg";
import eventDate6 from "../../../assets/eventdate/event6.jpeg";
import eventDate7 from "../../../assets/eventdate/event7.jpeg";
import eventDate8 from "../../../assets/eventdate/event8.jpeg";
import eventDate9 from "../../../assets/eventdate/event9.jpeg";
...
import scheduleIcon2 from "../../../assets/Scheduleicon2.png";
import scheduleIcon3 from "../../../assets/Scheduleicon3.png";
...
const FEATURE_ITEMS: EventFeatureItem[] = [
  {
    ...
    paragraphs: {
      en: [
        'The Boss Doesn’t Know Me: Old Friends Season 2, produced by BOSS Zhipin, is a workplace documentary series focusing on entrepreneurship, professional relationships, and career growth. Invited as a guest for its Podcast Special, Dennis (Yuxuan) Liu joined fellow guests in discussions on "emotion and reason in the workplace", sharing thoughtful insights on conflict, trust, and personal growth through stories from guests and audience submissions.',
      ],
      zh: [
        "《老板不知道的我・老友季2》是由 BOSS 直聘出品的职场纪实观察节目，聚焦合作创业、职场关系与职业成长。作为播客特别场受邀嘉宾，刘煜暄律师与多位嘉宾围绕“职场关系中的情与理”参与对谈，结合嘉宾故事与观众投稿，就冲突、默契与成长等话题分享了真诚而有见地的观察与思考。",
      ],
    },
    platforms: [
      {
        logo: eventDateLogo1.src,
        name: {
          en: "Tencent Video",
          zh: "腾讯视频",
        },
  ...
  },
  {
    ...
    paragraphs: {
      en: [
        "On November 28, 2025, Dennis (Yuxuan) Liu, as a leading legal content creator on Bilibili, was invited to speak at the 2025 Beijing International Audiovisual Conference · New Mass Literature & Art Ecosystem Forum, hosted by the Beijing Radio and Television Bureau and the Administrative Committee of Beijing Economic-Technological Development Area.",
      ...
      zh: [
        "2025年11月28日，刘煜暄律师作为B站法律垂类头部创作者，受邀出席由北京市广播电视局、北京经济技术开发区管委会主办的2025北京国际视听大会·新大众文艺生态论坛并发表专题分享。",
  ...
  },
  {
    ...
    paragraphs: {
      en: [
        "Dennis (Yuxuan) Liu was invited to Wuzhen to attend the 2025 Bilibili Charging Creator Exchange Day, and was selected as one of only three guest speakers on stage. At the event, Dennis communicated face-to-face with high-quality creators and platform partners from across the country. He shared the complete development journey and practical experience of Tiger Legal Talks — starting as a niche legal program, adhering to professional long-form content creation, focusing on content value, and growing into a leading legal video podcast. He also conducted in-depth discussions on content production, fan operation, platform ecosystem and long-term value, enabling mutual inspiration and joint progress among all participants.",
        "Theme: When Long-Form Content Meets Professionalism: A Charging Experiment of a Legal Video Podcast",
      ],
      zh: [
        "大暄哥（@中二的大暄哥）受邀前往乌镇，参与2025 B 站充电 UP 主交流日活动，并有幸作为全场三位分享嘉宾之一登台发言。大暄哥在现场与来自全国各地的优质创作者、平台伙伴面对面交流，完整分享了《Tiger Legal Talks》从法律垂类起步、坚持专业长视频创作、深耕内容价值、成长为头部法律视频播客的创作历程与实战心得，也围绕内容创作、粉丝运营、平台生态与长期价值展开深度探讨，在交流中互相启发、共同成长。",
        "主题：当长视频遇上专业主义：一档法律视频播客的充电试验",
      ],
    },
    platforms: [
      {
        logo: eventDateLogo4.src,
        name: {
          en: "Bilibili Video",
          zh: "bilibili 视频",
        },
  ...
  },
  {
    ...
    paragraphs: {
      en: [
        ...
        "Among them, Dennis (Yuxuan) Liu gave a talk titled “Running a ‘Small Workshop’ Is Great.” He shared his struggles and growth from student days to early practice, expressing his commitment to professional purity: focusing on cases, embracing long-termism, and valuing longevity over scale. Liu was voted “Second Place Storyteller” based on live sound-wave voting.",
      ],
      zh: [
        ...
        "其中，刘煜暄律师以「开个‘小作坊’也挺好」为主题，讲述了自己从求学成长到执业初期的挫折与蜕变，表达了对专业纯粹性的坚守: 专注办案、深耕专业、长期主义，不求最大，但求最久。经现场音浪统计，刘煜暄获评「故事二大王」。",
      ],
    },
    platforms: [],
  },
                  ...
                  >
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-3">
                      <div className="flex items-center gap-2 text-[#D9B27A]">
                        <img src={scheduleIcon.src} alt="" aria-hidden="true" className="h-4 w-4 object-contain opacity-90" />
                      ...
                      <div className="flex items-center justify-end gap-2">
                        <img src={scheduleIcon2.src} alt="" aria-hidden="true" className="h-4 w-4 object-contain opacity-85" />
                        <span
                    ...
                    >
                      <img src={scheduleIcon3.src} alt="" aria-hidden="true" className="h-4 w-4 object-contain" />
...
export function EventLandingPage() {
  ...
  const eventHeroImageSrc = getPageContentField(pageContent, language, "event", "hero", "heroImage", "") || eventHeroImage.src;
    ...
    <div className="min-h-screen bg-[#161915] text-white">
      ...
      <main>
        <LandingSharedHero
          ...
          imageAlt="Dennis Yuxuan Liu event portrait"
